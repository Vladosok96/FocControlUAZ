...
int BLDCMotor::getPosition() {
  if (fabs(shaft_angle - position_p) < threshold) {
    return GM_P;
  }
  if (fabs(shaft_angle - position_r) < threshold) {
    return GM_R;
  }
  if (fabs(shaft_angle - position_n) < threshold) {
    return GM_N;
  }
  if (fabs(shaft_angle - position_d) < threshold) {
    return GM_D;
  }
  return GM_UNDEFINED;
}
...
float BLDCMotor::getFloatPosition(int position) {
  switch (position) {
  case GM_P:
    return position_p;
  case GM_R:
